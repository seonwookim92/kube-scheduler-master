...
class SchedulerThread(QThread):
    def __init__(self, myWindow):
        ...
        self.scheduler = self.myWindow.scheduler
...
class WindowClass(QMainWindow, from_class):
    def __init__(self):
        ...
        self.rl_strategies_model_path = glob.glob(os.path.join(base_path, 'kube_rl_scheduler', 'strategies', 'model', '*.py'))
    ...
    def update_pod_state(self):
        ...
        if len(self.env.cluster.pending_pods) > 0:
            ...
            self.pod1_duration.setText(f"{self.pending_pod1.spec['duration']}s")
        ...
        if len(self.env.cluster.pending_pods) > 1:
            ...
            self.pod2_duration.setText(f"{self.pending_pod2.spec['duration']}s")
